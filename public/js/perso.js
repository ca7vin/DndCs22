...
filterWizardBtn.addEventListener("click", () => {
    spellClass.forEach((element) => {
        if (
            !element.innerText
                .toLowerCase()
                .includes(filterWizardContent.innerText.toLowerCase())
        ) {
...
filterDruidBtn.addEventListener("click", () => {
    spellClass.forEach((element) => {
        if (
            !element.innerText
                .toLowerCase()
                .includes(filterDruidContent.innerText.toLowerCase())
        ) {
            element.parentElement.parentElement.parentElement.classList.add(
                "hidden"
            );
...
filterSorcererBtn.addEventListener("click", () => {
    spellClass.forEach((element) => {
        if (
            !element.innerText
                .toLowerCase()
                .includes(filterSorcererContent.innerText.toLowerCase())
        ) {
            element.parentElement.parentElement.parentElement.classList.add(
                "hidden"
            );
...
filterClericBtn.addEventListener("click", () => {
    spellClass.forEach((element) => {
        if (
            !element.innerText
                .toLowerCase()
                .includes(filterClericContent.innerText.toLowerCase())
        ) {
            element.parentElement.parentElement.parentElement.classList.add(
                "hidden"
            );
...
filterWarlockBtn.addEventListener("click", () => {
    spellClass.forEach((element) => {
        if (
            !element.innerText
                .toLowerCase()
                .includes(filterWarlockContent.innerText.toLowerCase())
        ) {
            element.parentElement.parentElement.parentElement.classList.add(
                "hidden"
            );
...
filterBardBtn.addEventListener("click", () => {
    spellClass.forEach((element) => {
        if (
            !element.innerText
                .toLowerCase()
                .includes(filterBardContent.innerText.toLowerCase())
        ) {
            element.parentElement.parentElement.parentElement.classList.add(
                "hidden"
            );
...
filterRangerBtn.addEventListener("click", () => {
    spellClass.forEach((element) => {
        if (
            !element.innerText
                .toLowerCase()
                .includes(filterRangerContent.innerText.toLowerCase())
        ) {
            element.parentElement.parentElement.parentElement.classList.add(
                "hidden"
            );
...
filterPaladinBtn.addEventListener("click", () => {
    spellClass.forEach((element) => {
        if (
            !element.innerText
                .toLowerCase()
                .includes(filterPaladinContent.innerText.toLowerCase())
        ) {
            element.parentElement.parentElement.parentElement.classList.add(
                "hidden"
            );
