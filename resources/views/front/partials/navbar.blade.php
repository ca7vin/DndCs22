<nav class='flex justify-around items-center bg-gray-700 py-3'>
    <div class="flex items-center justify-around">
        <a href=""><i class="fa-solid text-gray-300 fa-dice-d20 fa-3x mr-3"></i></a>
        <span class="text-gray-300 text-2xl uppercase font-bold">Donjons & Dragons</span>
    </div>
