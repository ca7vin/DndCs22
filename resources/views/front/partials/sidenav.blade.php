                ...
                <i class='flex items-center justify-center'>
                    <svg class='icon' version="1.0" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <g transform="translate(0.000000,1280.000000) scale(0.100000,-0.100000)" fill="#ffffff"
                            stroke="none">
                            <path
                                d="M6260 12408 c0 -389 -12 -910 -21 -896 -5 7 -9 30 -9 51 0 52 -34
                            ...
                            <path
                                d="M10920 5475 c-10 -12 -7 -24 15 -62 15 -27 42 -102 60 -168 82 -293
            ...
            <button id='filterWizardBtn'>
                <i class='flex items-center justify-center'><svg class='icon' version="1.0"
                        ...
                        <g transform="translate(0.000000,1186.000000) scale(0.100000,-0.100000)" fill="#ffffff"
                            stroke="none">
                            <path
                                d="M1359 11813 c-18 -21 -265 -275 -548 -564 l-516 -525 -27 -110 c-15
            ...
            <button id='filterSorcererBtn'>
                <i class='flex items-center justify-center'><svg class='icon' version="1.0"
                        ...
                        <g transform="translate(0.000000,1280.000000) scale(0.100000,-0.100000)" fill="#ffffff"
                            stroke="none">
                            <path
                                d="M11591 12724 c-46 -20 -11500 -11470 -11529 -11525 -26 -47 -28 -93
                 ...
                 15 87 2 124 -6 15 -228 246 -493 511 -547 549 -547 549 -646 506z" />
                            <path
                                d="M5026 12463 c-17 -166 -24 -222 -35 -278 -7 -33 -16 -85 -22 -115
                 ...
                 -45 243 -49 271 -66 443 -3 39 -10 72 -14 72 -4 0 -10 -30 -14 -67z" />
                            <path
                                d="M11458 9560 c-8 -79 -24 -166 -37 -200 -5 -14 -17 -52 -27 -85 -9
                 ...
                 25 -5 17 -10 -30z" />
                            <path
                                d="M1880 8975 c0 -34 -40 -202 -60 -250 -4 -11 -18 -45 -30 -75 -28 -70
                ...
                <i class='flex items-center justify-center'>
                    <svg class='icon' version="1.0" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <g transform="translate(0.000000,1280.000000) scale(0.100000,-0.100000)" fill="#ffffff"
                            stroke="none">
                            <path
                                d="M4635 12781 c-111 -25 -182 -54 -267 -110 -209 -137 -342 -355 -364
            ...
            <button id='filterBardBtn'>
                <i class='flex items-center justify-center'><svg class='icon' version="1.0"
                        ...
                        <g transform="translate(0.000000,1280.000000) scale(0.100000,-0.100000)" fill="#ffffff"
                            stroke="none">
                            <path
                                d="M4104 11920 c-249 -81 -489 -399 -672 -890 -162 -435 -204 -853 -141
            ...
            <button id='filterRangerBtn'>
                <i class='flex items-center justify-center'><svg class="icon" version="1.0"
                        ...
                        <g transform="translate(0.000000,1246.000000) scale(0.100000,-0.100000)" fill="#ffffff"
                            stroke="none">
                            <path
                                d="M5562 12449 c-86 -17 -321 -101 -383 -137 -281 -164 -399 -527 -323
            ...
            <button id='filterPaladinBtn'>
                <i class='flex items-center justify-center'><svg class='icon' version="1.0"
                        ...
                        <g transform="translate(0.000000,1280.000000) scale(0.100000,-0.100000)" fill="#ffffff"
                            stroke="none">
                            <path
                                d="M6343 11110 c-46 -28 -58 -58 -109 -267 -56 -235 -86 -336 -131 -438
